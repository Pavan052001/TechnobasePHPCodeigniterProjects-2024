                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" method="post"
                                Action="<?php echo site_url('GuestController/update_action'); ?>"
                                ...
                                <div class="col-12">
                                  ...
                                  <label for="inputAddress" class="form-label">Address</label>
                                    <span class="text text-danger d-flex">* <?php echo form_error('address'); ?><span id="add-error" class="text text-danger"></span>
                                    </span>
                                  </div>
                                    <input type="text" class="form-control" value="<?php echo $address; ?>"
                                        name="address" id="address" placeholder="1234">
                                </div>
                                ...
                                <div class="form-group">
                                   ...
                                   <?= form_error('state_id');?></span> <span id="country_error" class="text text-danger"></span>
                                   </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <label class="form-label">City</label><span class="text text-danger d-flex"> *
                                        <?= form_error('city_id'); ?> <span id="city_error" class="text text-danger"></span></span>
                                        </div>
                                    <div>
                                ...
                                <div class="col-12">
                                 ...
                                 <span class="text text-danger d-flex">* <?php echo form_error('date') ?><span id="date_error" class="text text-danger"></span></span>
                                 </div>
                                        <div class="col-sm-10">
                                            <input type="text" name="date" id="dobpicker"
                                                value="<?php echo $date; ?>" class="form-control form-control-user datepicker">
                                        </div>
                                </div>
                                <div class="col-12">
                                    <label for="image" class="form-label">Upload Profile</label>
                                    <span class="text text-danger">* <?php echo form_error('image') ?><span id="error" class="text-danger d-flex"></span></span>
                                        <input type="file" class="form-control" name="image" id="image"
                                            placeholder="1234">
                                            <img width="60px"  src="<?php echo base_url("uploads/guestimage/").$photo?>">
                                </div>

                                <div class="form-group">
                                  <div class="d-flex">
                                  <label>Hobbies</label><span class="text text-danger d-flex"> *
                                  <?= form_error('hobby_id'); ?><span id="hobby-error" class="text text-danger"></span></span>
                                  </div><br />
                                    <?php $checkbox_count = 0;
                                    foreach ($allhobbies as $hobbyrow) { ?>
                                        <input type="checkbox" name="hobby_id[]" value=" <?= $hobbyrow->id ?>"
                                ...
                                <div class="col-12">
                                    ...
                                    <span class="text text-danger d-flex">* <?php echo form_error('gender') ?> <span id="gender-error" class="text text-danger"></span></span>
                        ...
                        <div class="text-center">
                            ...
                            <a href="<?php echo site_url("GuestController/getlist")?>" class="btn btn-danger">Cancel</a>
                        </div>
                        </form><!-- Vertical Form -->
...
<script>
    ...
    //  alert(state_id); selected state id
