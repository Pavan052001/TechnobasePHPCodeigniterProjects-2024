      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form method="post" action="<?= site_url("LeadController/export")?>">
									&nbsp;<button type="submit" id="idbtn" class="btn btn-primary mt-3">Export</button>
									<input type="hidden" class="collectid " name="collectid"/>
								</form>


              <a href="<?php echo site_url('LeadController/create') ?>" class="btn btn-primary bx-pull-right me-5">create
              </a>
              <br>
              <br>

              <!-- Table with stripped rows -->
             <form method="post" action="<?php echo site_url("LeadController/deleteall_action")?>">
             <table class="table datatable">
                ...
                <tbody>
                  <?php if (!empty($getalleads)): ?>
                    <?php $s = 1;
                    foreach ($getalleads as $row): ?>
                      <tr>
                        <td><input type="checkbox" class="leadid" name="selector[]" value="<?php echo $row->id ?>"></td>
                     <td><?php echo $s ;?></td>
                     <td><?php echo $row->name; ?></td>
                        ...
                        <td>
                          ...
                          <a href="<?php echo site_url('LeadController/update/' . $row->id) ?>" class=" me-3"><i
                              class="bi bi-pencil"></i></a>
                          <a href="<?php echo site_url('LeadController/delete/' . $row->id) ?>"  onclick="return confirm('Do you really want to delete this record')"
        ...
        <div class="card col-lg-6 col-md-6 col-sm-6 col-xs-12 box">
								<form method="post" action="<?php echo site_url("LeadController/import") ?>" enctype="multipart/form-data">
