    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-8 offset-2">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center">update Lead Source</h5>

              <!-- Vertical Form -->
              <form class="row g-3" method="post" Action="<?php echo site_url('LeadSourceController/update_action'); ?>"
              enctype="multipart/form-data">
                <div class="col-12 ">
                  <div class="d-flex">
                  <label for="inputNanme4" >Lead-Source tittle</label>
            ...
            <div class="text-center">
              ...
              <a href="<?php echo site_url("LeadSourceController/managelist")?>" class="btn btn-danger">Cancel</a>
            </div>
            </form><!-- Vertical Form -->
