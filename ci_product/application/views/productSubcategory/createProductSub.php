        ...
        <section class="section">
            <div class="row">
                ...
                <div class="col-lg-8 offset-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-center">Add Product-sub Caregory</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" method="post"
                                Action="<?php echo site_url('ProductSubController/create_action'); ?>"
                                ...
                                <div class="col-12">
                                    <div class="d-flex">
                                        ...
                                        <span
                                            class="text text-danger d-flex">*&nbsp;<?php echo form_error("category_id"); ?></span>
                                        <span id="cat_error" class="text text-danger"></span>
                                    </div>
                                    <select class="form-control" name="category_id" id="category_id">
                                        <option value="">--Select product category--</option>
                                        <?php foreach ($allCategory as $row) { ?>
                                            <option value="<?= $row->id; ?>" <?php echo !empty($category) && $category == $row->id ? 'selected' : ''; ?>>
                                                <?= $row->category_name; ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                        ...
                        <div class="text-center">
                            ...
                            <a href="<?php echo site_url("ProductSubController/getlist") ?>"
