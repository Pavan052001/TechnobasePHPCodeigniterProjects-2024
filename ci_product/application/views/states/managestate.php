      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form method="post" action="<?= site_url("StateController/export")?>">
									&nbsp;<button type="submit" id="stateidbtn" class="btn btn-primary mt-3">Export</button>
									<input type="hidden" class="statecollectid " name="statecollectid"/>
								</form>

          
              <a href="<?php echo site_url('StateController/create') ?>" class="btn btn-primary bx-pull-right me-5">create
              </a>
              <br>
              <br>

              <!-- Table with stripped rows -->
             <form method="post" action="<?php echo site_url("StateController/deleteall_action")?>">
                ...
                <tbody>
                  <?php if (!empty($allstate)): ?>
                    ...
                    foreach ($allstate as $row): ?>
                      <tr>
                        <td><input type="checkbox" class="stateid" name="selector[]" value="<?php echo $row->id ?>"></td>
                     <td><?php echo $s ;?></td>
                        ...
                        <td>
                          ...
                          <a href="<?php echo site_url('StateController/update/' . $row->id) ?>" class=" me-3"><i
                              class="bi bi-pencil"></i></a>
                          <a href="<?php echo site_url('StateController/deleteState/' . $row->id) ?>"  onclick="return confirm('Do you really want to delete this record')"
        ...
        <div class="card col-lg-6 col-md-6 col-sm-6 col-xs-12 box">
								<form method="post" action="<?php echo site_url("StateController/import") ?>" enctype="multipart/form-data">
