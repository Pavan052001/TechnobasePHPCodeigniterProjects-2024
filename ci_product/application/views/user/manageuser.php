    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
            <form method="post" action="<?= site_url("UserController/export")?>">
									&nbsp;<button type="submit" id="idbtn" class="btn btn-primary mt-3">Export</button>
									<input type="hidden" class="collectid " name="collectid"/>
								</form>

              <a href="<?php echo site_url('UserController/create') ?>" class="btn btn-primary bx-pull-right me-5">create
                User</a>
              <br>
              <br>

              <!-- Table with stripped rows -->
             <form action="<?php echo site_url("UserController/deleteall_action")?>" method="post">
                ...
                <tbody>
                  <?php if (!empty($allusers)): ?>
                    ...
                    foreach ($allusers as $row): ?>
                     ...
                     <td><?php echo $s ;?></td>
                     <td><img src="<?= base_url();?>uploads/userimage/<?= $row->image?>" width="50px"/></td> 
                        ...
                        <td>
                          <a href="<?php echo site_url('UserController/viewUser/' . $row->id) ?>" class=" me-3"><i
                              class="bi bi-eye-fill"></i></a>
                          <a href="<?php echo site_url('UserController/UserUpdate/' . $row->id) ?>" class=" me-3"><i
                              class="bi bi-pencil"></i></a>
                          <a href="<?php echo site_url('UserController/delete/' . $row->id) ?>"
        ...
        <div class="card col-lg-6 col-md-6 col-sm-6 col-xs-12 box">
								<form method="post" action="<?php echo site_url("UserController/import") ?>" enctype="multipart/form-data">
